...
export function EditiDipendente({ customerId, onClose, fetchemployee }) {
  ...
  const [orariDiLavoro, setOrariDiLavoro] = useState({
    ...
    domenica: { inizio: "09:00", fine: "19:00", chiuso: true } // Domenica chiusa di default
  });

  // Array dei giorni in italiano (in minuscolo) per iterare la sezione orari
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Aggiorna il documento nella collezione "employee"
